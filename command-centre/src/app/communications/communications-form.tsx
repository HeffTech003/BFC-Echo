      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">
            Member ID <span className="text-muted-foreground font-normal">(optional — links send to member record)</span>
          </label>
          <input
            type="text"
            className="w-full rounded-md border bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring"
        ...
        {selectedTpl.needsVars.length > 0 && (
          <div>
            <label className="block text-sm font-medium mb-2">
              Template variables
              <span className="ml-1 text-xs text-muted-foreground font-normal">(personalise the message)</span>
            </label>
